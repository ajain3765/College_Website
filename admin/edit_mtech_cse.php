...
<body>
	...
	<?php
        ...
        $result = mysqli_query($con,"SELECT * FROM studentinfo where studentinfo.degree='PG' AND studentinfo.course='CSE'");
        ...
        <th><a href="delete_mtech_cse.php?rollno=<?php echo $row['rollno']; ?>"> <i class="fa fa-trash"></i></a></th>
        </tr>
