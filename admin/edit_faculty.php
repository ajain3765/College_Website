...
<body>
	...
	<?php
        ...
        $result = mysqli_query($con,"SELECT * FROM facultyinfo");
	   ...
	   <td><?php echo $row['id']; ?> </td>
        ...
        <td><?php echo $row['contact']; ?> </td>
          <td><a href="add_faculty.php?id=<?php echo $row['id']; ?>"><i class="fa fa-edit"></i></a></td>
        	<td><a href="delete_faculty.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash"></i></a></td>
        </tr>
