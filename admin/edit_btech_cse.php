...
<body>
	...
	<?php
        ...
        $result = mysqli_query($con,"SELECT * FROM studentinfo where studentinfo.degree='UG'");
        ...
        <th><a href="delete_btech_cse.php?rollno=<?php echo $row['rollno']; ?>"> <i class="fa fa-trash"></i></a></th>
        </tr>
