...
<body>
    ...
    <div class="container" style="margin-top: 50px; margin-bottom: 50px;">
        ...
        <table style="width:50%;">
            <tr>
              <td>
                <form method="get" action="add_faculty.php">
                    <label for="id"><b>Show by Faculty Id:</b></label><br>
                    <input type="text" placeholder="Faculty Id" name="id" required style="width: 50%;">&nbsp;&nbsp;
            ...
            <tr>
              <td>
                <form method="get" action="edit_faculty.php">
                    <button type="submit" style="border-radius: 12px;">Show All Faculties</button>
                </form>
              </td>
            </tr>
          </table>
