...
<body>
    ...
    <div class="container" style="margin-top: 12px;">
        ...
        <!--******************** Edit This Tab ********************-->
        <div style="margin: 1%;">
        <h3>M-TECH CSE-IS STUDENTS</h3><hr>
...
<?php
		...
		$id= $_GET['id'];
        $result = mysqli_query($con,"SELECT * FROM studentinfo where studentinfo.course='CSE-IS' and studentinfo.degree='PG' and (studentinfo.semester='$id' or studentinfo.semester='$id+1' )");
