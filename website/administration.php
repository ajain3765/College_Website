...
<title>Administration | Computer Science Department</title>
...
<body>
    ...
    <div class="container" style="margin-top: 12px;">
        ...
        $result = mysqli_query($con,"SELECT facultyinfo.name,facultyinfo.designation,facultyinfo.specialization,facultyinfo.email,facultyinfo.contact FROM facultyinfo");
