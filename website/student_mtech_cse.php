...
<body>
    ...
    <div class="container" style="margin-top: 12px;">
		...
		$id= $_GET['id'];
        $result = mysqli_query($con,"SELECT * FROM studentinfo where studentinfo.course='CSE' and studentinfo.degree='PG' and (studentinfo.semester='$id' or studentinfo.semester='$id+1' )");
