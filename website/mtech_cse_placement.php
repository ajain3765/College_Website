...
<body>
    ...
    <div class="container" style="margin-top: 12px;">
        ...
        <div style="margin: 1%;">
        <h3>Placements Statistics of M-TECH CSE Students:</h3><hr>   
        <?php
		...
		$id= $_GET['id'];
        $result = mysqli_query($con,"SELECT * FROM studentinfo where studentinfo.course='CSE' and studentinfo.degree='PG' and semester='3' and studentinfo.company_placed is not NULL");
