...
<body>
    ...
    <div class="container" style="margin-top: 12px;">
        ...
        <div style="margin: 1%;">
        <h3>Placements Statistics of B-TECH CSE Students:</h3><hr>   
        <?php
		...
		$id= $_GET['id'];
        $result = mysqli_query($con,"SELECT * FROM studentinfo where studentinfo.semester='7' and studentinfo.degree='UG' and studentinfo.company_placed is not NULL");
